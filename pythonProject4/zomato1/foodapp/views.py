...
class UserAPIView(APIView):
    ...
    def post(self, request, format=None):
        try:
            ...
            return Response({'erroar': str(e)}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            restaurant = Restaurant(
                ...
                city=restaurant_data.get('city', ''),                phone_number=restaurant_data.get('phone_number', ''),
...
class updateRestaurantMenu(APIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [CustomPermission]
    ...
    def put(self,request,):
        try:
            ...
            menu_item=MenuItem.objects.get(name=restaurant_name)
            for item in menu_item_data:
                menu_item.name = item.name,
                menu_item.restaurant = item.restaurant,
                menu_item.restaurant = item.restaurant,
                menu_item.restaurant = item.restaurant,
                menu_item.restaurant = item.restaurant,
                name = item.name,
